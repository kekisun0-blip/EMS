...
// ─── r128 compatibility shims ───────────────────────────────
if(typeof THREE.SRGBColorSpace==='undefined')THREE.SRGBColorSpace=THREE.sRGBEncoding;
if(typeof THREE.LinearSRGBColorSpace==='undefined')THREE.LinearSRGBColorSpace=THREE.LinearEncoding;
if(typeof THREE.NoColorSpace==='undefined')THREE.NoColorSpace=THREE.LinearEncoding;
if(typeof THREE.ColorManagement==='undefined')THREE.ColorManagement={enabled:false,workingColorSpace:'linear',toWorkingColorSpace:function(c){return c;},fromWorkingColorSpace:function(c){return c;}};
// r128 Color.setRGB does not accept a 4th colorSpace param - patch to accept it
(function(){
  const origSetRGB=THREE.Color.prototype.setRGB;
  THREE.Color.prototype.setRGB=function(r,g,b,_cs){return origSetRGB.call(this,r,g,b);};
})();
// patch TextureLoader / assignTexture colorSpace property (r128 uses encoding)
const _origTexture=THREE.Texture;
if(_origTexture){
  const origCsDesc=Object.getOwnPropertyDescriptor(_origTexture.prototype,'colorSpace');
  if(!origCsDesc){
    Object.defineProperty(_origTexture.prototype,'colorSpace',{
      get:function(){return this._colorSpace||THREE.SRGBColorSpace;},
      set:function(v){this._colorSpace=v;this.encoding=v;}
    });
  }
}
// ─────────────────────────────────────────────────────────────
